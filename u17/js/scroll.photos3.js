window.imgscroll = {
	...
	endLoad: function(width){
		...
		this.options.target.append('<div style="text-align:center;color:#999;padding-bottom:0px;font-size:13px;"><img src="'+this.options.img_list[this.options.img_num].url+'" width="'+width+'"></div>');
