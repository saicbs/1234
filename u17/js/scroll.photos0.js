window.imgscroll = {
	...
	endLoad: function(width){
		...
		this.options.target.append('<div style="text-align:center;color:#999;padding-bottom:0px;font-size:0px;"><img src="'+this.options.img_list[this.options.img_num].url+'" width="'+width+'"><br /><span>'+ (this.options.img_num+1) +'/'+ this.options.img_max +'</span></div>');
